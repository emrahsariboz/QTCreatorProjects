...
public:
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        verticalSpacer_2 = new QSpacerItem(20, 331, QSizePolicy::Minimum, QSizePolicy::Expanding);
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        tab1Button->setText(QCoreApplication::translate("Widget", "Tab 1", nullptr));
